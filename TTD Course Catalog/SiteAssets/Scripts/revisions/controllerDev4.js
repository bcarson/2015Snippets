...
function updateListItem(item, newtitle)
{
		var index = item.charAt(0);
		//alert(item);
        var oList = web.get_lists().getByTitle('Training Calendar');
        //console.log(oList[0]);
     
        this.oListItem = oList.getItemById(index);
...
/*********************************************
  ...
  ********************************************/
	...
	$scope.ping = function(item, newtitle) {
		updateListItem(item, newtitle)
	}
